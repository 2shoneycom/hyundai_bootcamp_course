...
<script type="text/javascript">
	function submitHandler() {
		// (방식 2번) 파라미터라이제이션
		let value = document.querySelector("textarea[name='content']").value;
		...
		value = value.replaceAll("'", "&#x27;");
		value = value.replaceAll("\"", "&quot;");
		document.querySelector("textarea[name='content']").value = value;
	}
</script>
<title>글 수정</title>
</head>
<body>
  ...
  try {
  	...
  	while (result.next()) {
  %>
  <form action="post_modify_send.jsp" method="post" onsubmit="return submitHandler()">
