...
public class BooksaleList {
	...
	public static void showAllBooksale(Vector<BooksaleDTO> dataSet) {
		System.out.println("\n*******************************");
		System.out.println("도서 구매 내역 조회");
		System.out.println("*********************************");
		
		System.out.println("구매번호\t 구매일\t\t  수량\t\t 구매자\t\t 도서번호");
		System.out.println("--------------------------------------------");
		
		for (BooksaleDTO dto : dataSet) {
